  ...
  if (!subFields || subFields.length === 0) {
    return (
      <div className="pt-6 border-t border-gray-200 dark:border-gray-800">
        <h3 className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 tracking-wider uppercase">
          {label}
        </h3>
        <p className="text-sm text-red-500">
          Error: No sub-fields configured for this Object Group.
        </p>
      </div>
    );
  }
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {subFields.map((sf) => {
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <EntityReferenceField
                            ...
                            multiple={
                              sf.type === "reference_list" || sf.type === "list"
                            }
                            error={!!error}
                  ...
                  if (sf.type === "object_array") {
                    return (
                      <div className="col-span-1 md:col-span-2" key={sf.key}>
                        <ObjectArrayField
                          name={`${name}.${i}.${sf.key}`}
                          label={sf.label}
                          game={game}
